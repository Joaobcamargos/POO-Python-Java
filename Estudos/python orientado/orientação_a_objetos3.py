...
# Resultados: Neste código,foi implementado e testado o construtor def __init__ e o metodo def Assar , além disso também foi utilizado um tratamento de erros básico.